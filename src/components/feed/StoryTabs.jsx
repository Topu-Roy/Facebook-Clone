...
const StoryTabs = () => {
  return (
    <>
      <div className="flex items-center justify-between gap-1 px-3.5 pt-1">
        <button className="flex h-full flex-1 items-center justify-center gap-2 border-b-[3px] border-blue-600 py-3.5">
          <svg
            fill="#666666"
            viewBox="0 0 20 20"
            width="1.25rem"
        ...
        <button className="flex h-full flex-1 items-center justify-center gap-2 rounded-lg py-3.5 hover:bg-gray-100">
          <svg
            fill="#666666"
            viewBox="0 0 20 20"
            width="1.25rem"
